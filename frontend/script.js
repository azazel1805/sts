...
const questions = [
    ...
    { id: '66', text: "66. A university degree, according to some, should help graduates ________ better employment.", options: { a: 'take', b: 'comprehend', c: 'land', d: 'find' } }, // c or d
    { id: '67', text: "67. Ivy League universities such as Harvard, Oxford and Cambridge have the best professors in the world, and they hold seminars for the public good while integrating science ________ innovations and discoveries ________ the lives of people.", options: { a: 'in/ using', b: 'into/through', c: 'from/ beside', d: 'into/ upon' } }, // Needs 2 blanks - unclear choice
    ...
    { id: '72', text: "72. <u>On the heels of</u> the announcement of Queen Elizabeth's obituary, Commonwealth countries flew their flags at half must to show their grief and respect.", options: { a: 'Far behind', b: 'Following closely', c: 'Ahead', d: 'Before' } },
    { id: '73', text: "73. After a minute of silence, all people <u>zeroed in on</u> the words coming out of the next of kin's mouth. the synonym for the word underlined is:", options: { a: 'focus', b: 'skirt', c: 'circumvent', d: 'lag' } },
    ...
    { id: '76', text: "76. <u>Mandatory</u> practices like donning masks in public areas or being vaccinated to have the right to enter public places caused a big dilemma in certain parts of society during COVID-19.", options: { a: 'Discretionary', b: 'Dispensable', c: 'Voluntary', d: 'Compulsory' } }, // Antonym is needed, so A or C? Mandatory vs Voluntary = C. Vs Discretionary = A. Context implies choice vs no choice. A fits better.
    ...
    { id: '87', text: "87. A vast majority of customers with high awareness do not opt for purchasing products produced in sweatshops due to the <u>dire</u> conditions of the workers.", options: { a: 'Mild', b: 'Encouraging', c: 'Terrible', d: 'Good' } }, // 'dire' in text -> Terrible
    { id: '88', text: "88. Scientifically supported methods and his theory have gained <u>seminal</u> role, given that he constantly paved the way for positive outcomes.", options: { a: 'Groundbreaking', b: 'Negligible', c: 'Barren', d: 'Trifling' } }, // seminal -> groundbreaking/influential
